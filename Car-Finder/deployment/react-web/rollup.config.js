...
export default {
    ...
    plugins: [
        mendixResolve(
            ...
            "D:/UKTC PROGRAMMING/Mendix-Projects/Car-Finder/deployment/web/cachetag.txt"
        ),
        nodePolyfills(),
        esbuild({
        ...
        generatePrecacheServiceWorker({
            deploymentDir: "D:/UKTC PROGRAMMING/Mendix-Projects/Car-Finder/deployment"
        }),
        copy({
            targets: [
              { src: 'D:/UKTC PROGRAMMING/Mendix-Projects/Car-Finder/deployment/web/widgets/*', dest: 'dist' },
            ]
        })
    ],
};
