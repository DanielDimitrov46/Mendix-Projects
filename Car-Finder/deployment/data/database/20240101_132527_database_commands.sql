...
ALTER TABLE "myfirstmodule$ad_user" RENAME TO "e6a7cba027664501896326f0ed9ebf1c";
...
ALTER TABLE "myfirstmodule$ad_vehicle" RENAME TO "f3031432272b4f718b696faf6d010c8b";
...
ALTER TABLE "myfirstmodule$gallery_vehicle" RENAME TO "c89e1552edf74a5cb5c65c05e348da61";
...
ALTER TABLE "myfirstmodule$vehicle_car" RENAME TO "da88353c53104258896354f0c1007a01";
ALTER TABLE "myfirstmodule$ad" RENAME TO "f0319f3e2d5549d9b4349925d0ce3f21";
DROP SEQUENCE "myfirstmodule$ad_adid_mxseq";
ALTER TABLE "myfirstmodule$car" RENAME TO "fe939175ca7b42d983778340a22ebbfe";
ALTER TABLE "myfirstmodule$motorcycle" RENAME TO "3fda3659bbeb4eef916e29d31cacdc03";
ALTER TABLE "myfirstmodule$gallery" RENAME TO "faddac7994b844fa846698061d56d8e8";
DROP INDEX "idx_myfirstmodule$vehicle_submetaobjectname_asc";
ALTER TABLE "myfirstmodule$vehicle" RENAME TO "34b2ea2a23ba46f2ad6708f636d3bace";
ALTER TABLE "myfirstmodule$truck" RENAME TO "c93b10062411498aabf43896e9319889";
ALTER TABLE "myfirstmodule$user" RENAME TO "3c77283b302e4b90a273d1cf97ca519e";
...
DELETE FROM "forgotpassword$forgotpassword_account"  WHERE "administration$accountid" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
DELETE FROM "administration$account"  WHERE "id" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
DELETE FROM "system$user_language"  WHERE "system$userid" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
DELETE FROM "system$userroles"  WHERE "system$userid" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
DELETE FROM "system$user_timezone"  WHERE "system$userid" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "email_connector$incomingemailconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "deeplink$pendinglink" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "email_connector$emailaccount" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "system$filedocument" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$valuetype" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "email_connector$emailaccount" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
DELETE FROM "system$tokeninformation_user"  WHERE "system$userid" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$mxobjectenumvalue" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "email_connector$emailtemplate" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "email_connector$emailtemplate" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "system$processedqueuetask" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
DELETE FROM "system$workflowusertask_targetusers"  WHERE "system$userid" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "system$workflow" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$mxobjectenumcaptions" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$microflows" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "email_connector$ldapconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "email_connector$emailmessage" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "deeplink$pendinglink" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "email_connector$oauthtoken" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "email_connector$outgoingemailconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$mxobjecttype" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
DELETE FROM "system$session_user"  WHERE "system$userid" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "email_connector$incomingemailconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
DELETE FROM "system$workflowactivity_actor"  WHERE "system$userid" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$mxobjectmember" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
DELETE FROM "system$workflowactivityusertaskoutcome_user"  WHERE "system$userid" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "email_connector$oauthprovider" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "deeplink$entity" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$parameter" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$token" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$mxobjectenumvalue" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
DELETE FROM "system$workflowusertask_assignees"  WHERE "system$userid" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "system$filedocument" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "email_connector$oauthprovider" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "email_connector$outgoingemailconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
DELETE FROM "forgotpassword$forgotpassword_anon_user_access"  WHERE "system$userid" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "deeplink$microflow" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$mxobjectmember" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "system$synchronizationerror" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "deeplink$deeplink" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "deeplink$microflow" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$valuetype" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "deeplink$attribute" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$mxobjectreference" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "deeplink$entity" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$parameter" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
DELETE FROM "system$workflowusertaskoutcome_user"  WHERE "system$userid" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$mxobjectreference" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
DELETE FROM "system$userreportinfo_user"  WHERE "system$userid" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$microflows" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "email_connector$ldapconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "email_connector$oauthtoken" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "deeplink$attribute" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "deeplink$deeplink" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$mxobjecttype" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "system$queuedtask" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$mxobjectenumcaptions" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
UPDATE "mxmodelreflection$token" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
DELETE FROM "system$user"  WHERE "id" IN ( SELECT "id" FROM "3c77283b302e4b90a273d1cf97ca519e" );
DELETE FROM "da88353c53104258896354f0c1007a01"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "c93b10062411498aabf43896e9319889" );
DELETE FROM "c89e1552edf74a5cb5c65c05e348da61"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "c93b10062411498aabf43896e9319889" );
DELETE FROM "f3031432272b4f718b696faf6d010c8b"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "c93b10062411498aabf43896e9319889" );
DELETE FROM "34b2ea2a23ba46f2ad6708f636d3bace"  WHERE "id" IN ( SELECT "id" FROM "c93b10062411498aabf43896e9319889" );
DELETE FROM "system$thumbnail_image"  WHERE "system$imageid" IN ( SELECT "id" FROM "faddac7994b844fa846698061d56d8e8" );
DELETE FROM "system$image"  WHERE "id" IN ( SELECT "id" FROM "faddac7994b844fa846698061d56d8e8" );
DELETE FROM "system$filedocument"  WHERE "id" IN ( SELECT "id" FROM "faddac7994b844fa846698061d56d8e8" );
DELETE FROM "da88353c53104258896354f0c1007a01"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "3fda3659bbeb4eef916e29d31cacdc03" );
DELETE FROM "c89e1552edf74a5cb5c65c05e348da61"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "3fda3659bbeb4eef916e29d31cacdc03" );
DELETE FROM "f3031432272b4f718b696faf6d010c8b"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "3fda3659bbeb4eef916e29d31cacdc03" );
DELETE FROM "34b2ea2a23ba46f2ad6708f636d3bace"  WHERE "id" IN ( SELECT "id" FROM "3fda3659bbeb4eef916e29d31cacdc03" );
DROP TABLE "e6a7cba027664501896326f0ed9ebf1c";
DROP TABLE "f3031432272b4f718b696faf6d010c8b";
DROP TABLE "c89e1552edf74a5cb5c65c05e348da61";
DROP TABLE "da88353c53104258896354f0c1007a01";
DROP TABLE "f0319f3e2d5549d9b4349925d0ce3f21";
DROP TABLE "fe939175ca7b42d983778340a22ebbfe";
DROP TABLE "3fda3659bbeb4eef916e29d31cacdc03";
DROP TABLE "faddac7994b844fa846698061d56d8e8";
DROP TABLE "34b2ea2a23ba46f2ad6708f636d3bace";
DROP TABLE "c93b10062411498aabf43896e9319889";
DROP TABLE "3c77283b302e4b90a273d1cf97ca519e";
UPDATE "mendixsystem$version" SET "versionnumber" = '4.2', "lastsyncdate" = '20240101 13:25:27';
