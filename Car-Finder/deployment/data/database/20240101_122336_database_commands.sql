...
ALTER TABLE "myfirstmodule$ad_user" RENAME TO "0010435afa7942f7a65eaaa11c0e12a7";
...
ALTER TABLE "myfirstmodule$ad_vehicle" RENAME TO "4488e44d68624891a2f889456ecf188a";
...
ALTER TABLE "myfirstmodule$gallery_vehicle" RENAME TO "a9942baa6c2447259926a0f7836f6d6c";
...
ALTER TABLE "myfirstmodule$vehicle_car" RENAME TO "e6afdf86699e46e382463931d354ce2f";
ALTER TABLE "myfirstmodule$ad" RENAME TO "089a2de018fe46b98ff3b3b7f3749afd";
DROP SEQUENCE "myfirstmodule$ad_adid_mxseq";
ALTER TABLE "myfirstmodule$car" RENAME TO "31378c0f6e614a89bdccaaf353b901c9";
ALTER TABLE "myfirstmodule$motorcycle" RENAME TO "77adbfcc66474805a228716e8047075b";
ALTER TABLE "myfirstmodule$gallery" RENAME TO "a8db66bc93204213a785260862bfdefd";
DROP INDEX "idx_myfirstmodule$vehicle_submetaobjectname_asc";
ALTER TABLE "myfirstmodule$vehicle" RENAME TO "2e3897a893384d52895d340574e8ca5a";
ALTER TABLE "myfirstmodule$truck" RENAME TO "f752ae18fe0d4df5b61848e70273a4af";
ALTER TABLE "myfirstmodule$user" RENAME TO "d356e576a54a4c8883077477a2c2f97a";
...
DELETE FROM "forgotpassword$forgotpassword_account"  WHERE "administration$accountid" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
DELETE FROM "administration$account"  WHERE "id" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
DELETE FROM "system$user_language"  WHERE "system$userid" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
DELETE FROM "system$userroles"  WHERE "system$userid" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
DELETE FROM "system$user_timezone"  WHERE "system$userid" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "email_connector$incomingemailconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "deeplink$pendinglink" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "email_connector$emailaccount" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "system$filedocument" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$valuetype" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "email_connector$emailaccount" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
DELETE FROM "system$tokeninformation_user"  WHERE "system$userid" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$mxobjectenumvalue" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "email_connector$emailtemplate" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "email_connector$emailtemplate" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "system$processedqueuetask" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
DELETE FROM "system$workflowusertask_targetusers"  WHERE "system$userid" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "system$workflow" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$mxobjectenumcaptions" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$microflows" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "email_connector$ldapconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "email_connector$emailmessage" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "deeplink$pendinglink" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "email_connector$oauthtoken" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "email_connector$outgoingemailconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$mxobjecttype" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
DELETE FROM "system$session_user"  WHERE "system$userid" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "email_connector$incomingemailconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
DELETE FROM "system$workflowactivity_actor"  WHERE "system$userid" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$mxobjectmember" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
DELETE FROM "system$workflowactivityusertaskoutcome_user"  WHERE "system$userid" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "email_connector$oauthprovider" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "deeplink$entity" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$parameter" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$token" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$mxobjectenumvalue" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
DELETE FROM "system$workflowusertask_assignees"  WHERE "system$userid" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "system$filedocument" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "email_connector$oauthprovider" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "email_connector$outgoingemailconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
DELETE FROM "forgotpassword$forgotpassword_anon_user_access"  WHERE "system$userid" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "deeplink$microflow" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$mxobjectmember" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "system$synchronizationerror" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "deeplink$deeplink" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "deeplink$microflow" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$valuetype" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "deeplink$attribute" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$mxobjectreference" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "deeplink$entity" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$parameter" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
DELETE FROM "system$workflowusertaskoutcome_user"  WHERE "system$userid" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$mxobjectreference" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
DELETE FROM "system$userreportinfo_user"  WHERE "system$userid" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$microflows" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "email_connector$ldapconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "email_connector$oauthtoken" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "deeplink$attribute" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "deeplink$deeplink" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$mxobjecttype" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "system$queuedtask" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$mxobjectenumcaptions" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
UPDATE "mxmodelreflection$token" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
DELETE FROM "system$user"  WHERE "id" IN ( SELECT "id" FROM "d356e576a54a4c8883077477a2c2f97a" );
DELETE FROM "e6afdf86699e46e382463931d354ce2f"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "f752ae18fe0d4df5b61848e70273a4af" );
DELETE FROM "a9942baa6c2447259926a0f7836f6d6c"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "f752ae18fe0d4df5b61848e70273a4af" );
DELETE FROM "4488e44d68624891a2f889456ecf188a"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "f752ae18fe0d4df5b61848e70273a4af" );
DELETE FROM "2e3897a893384d52895d340574e8ca5a"  WHERE "id" IN ( SELECT "id" FROM "f752ae18fe0d4df5b61848e70273a4af" );
DELETE FROM "system$thumbnail_image"  WHERE "system$imageid" IN ( SELECT "id" FROM "a8db66bc93204213a785260862bfdefd" );
DELETE FROM "system$image"  WHERE "id" IN ( SELECT "id" FROM "a8db66bc93204213a785260862bfdefd" );
DELETE FROM "system$filedocument"  WHERE "id" IN ( SELECT "id" FROM "a8db66bc93204213a785260862bfdefd" );
DELETE FROM "e6afdf86699e46e382463931d354ce2f"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "77adbfcc66474805a228716e8047075b" );
DELETE FROM "a9942baa6c2447259926a0f7836f6d6c"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "77adbfcc66474805a228716e8047075b" );
DELETE FROM "4488e44d68624891a2f889456ecf188a"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "77adbfcc66474805a228716e8047075b" );
DELETE FROM "2e3897a893384d52895d340574e8ca5a"  WHERE "id" IN ( SELECT "id" FROM "77adbfcc66474805a228716e8047075b" );
DROP TABLE "0010435afa7942f7a65eaaa11c0e12a7";
DROP TABLE "4488e44d68624891a2f889456ecf188a";
DROP TABLE "a9942baa6c2447259926a0f7836f6d6c";
DROP TABLE "e6afdf86699e46e382463931d354ce2f";
DROP TABLE "089a2de018fe46b98ff3b3b7f3749afd";
DROP TABLE "31378c0f6e614a89bdccaaf353b901c9";
DROP TABLE "77adbfcc66474805a228716e8047075b";
DROP TABLE "a8db66bc93204213a785260862bfdefd";
DROP TABLE "2e3897a893384d52895d340574e8ca5a";
DROP TABLE "f752ae18fe0d4df5b61848e70273a4af";
DROP TABLE "d356e576a54a4c8883077477a2c2f97a";
UPDATE "mendixsystem$version" SET "versionnumber" = '4.2', "lastsyncdate" = '20240101 12:23:35';
