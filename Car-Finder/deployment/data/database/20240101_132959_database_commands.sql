...
ALTER TABLE "myfirstmodule$ad_user" RENAME TO "a25669c057084fefb2930d75966a7bc2";
...
ALTER TABLE "myfirstmodule$ad_vehicle" RENAME TO "fe20f68649d34fe2bc41e2b4af3d57d2";
...
ALTER TABLE "myfirstmodule$gallery_vehicle" RENAME TO "99676624691e4d6ba428498aa9e7e9f0";
...
ALTER TABLE "myfirstmodule$vehicle_car" RENAME TO "2200ad66b4ce4d458d8435b84a10aa0d";
ALTER TABLE "myfirstmodule$ad" RENAME TO "669252c0fdeb4cae9e81b7ea43bff89a";
DROP SEQUENCE "myfirstmodule$ad_adid_mxseq";
ALTER TABLE "myfirstmodule$car" RENAME TO "616195c65b7c4bf3a79402dba86033b9";
ALTER TABLE "myfirstmodule$motorcycle" RENAME TO "81f989d0e9dd41709fef1c6cb19965ee";
ALTER TABLE "myfirstmodule$gallery" RENAME TO "4689fa1484de4033bb66085f71aab966";
DROP INDEX "idx_myfirstmodule$vehicle_submetaobjectname_asc";
ALTER TABLE "myfirstmodule$vehicle" RENAME TO "55ff5c010d4d46799c7262bdf70cd7b6";
ALTER TABLE "myfirstmodule$truck" RENAME TO "f6d74e7e4a6e4f1da97dd0ceef2cac8a";
ALTER TABLE "myfirstmodule$user" RENAME TO "f5fc30cfccd84318bc882cf5920f3863";
...
DELETE FROM "forgotpassword$forgotpassword_account"  WHERE "administration$accountid" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
DELETE FROM "administration$account"  WHERE "id" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
DELETE FROM "system$user_language"  WHERE "system$userid" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
DELETE FROM "system$userroles"  WHERE "system$userid" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
DELETE FROM "system$user_timezone"  WHERE "system$userid" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "email_connector$incomingemailconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "deeplink$pendinglink" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "email_connector$emailaccount" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "system$filedocument" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$valuetype" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "email_connector$emailaccount" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
DELETE FROM "system$tokeninformation_user"  WHERE "system$userid" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$mxobjectenumvalue" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "email_connector$emailtemplate" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "email_connector$emailtemplate" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "system$processedqueuetask" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
DELETE FROM "system$workflowusertask_targetusers"  WHERE "system$userid" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "system$workflow" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$mxobjectenumcaptions" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$microflows" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "email_connector$ldapconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "email_connector$emailmessage" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "deeplink$pendinglink" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "email_connector$oauthtoken" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "email_connector$outgoingemailconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$mxobjecttype" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
DELETE FROM "system$session_user"  WHERE "system$userid" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "email_connector$incomingemailconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
DELETE FROM "system$workflowactivity_actor"  WHERE "system$userid" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$mxobjectmember" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
DELETE FROM "system$workflowactivityusertaskoutcome_user"  WHERE "system$userid" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "email_connector$oauthprovider" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "deeplink$entity" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$parameter" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$token" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$mxobjectenumvalue" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
DELETE FROM "system$workflowusertask_assignees"  WHERE "system$userid" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "system$filedocument" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "email_connector$oauthprovider" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "email_connector$outgoingemailconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
DELETE FROM "forgotpassword$forgotpassword_anon_user_access"  WHERE "system$userid" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "deeplink$microflow" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$mxobjectmember" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "system$synchronizationerror" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "deeplink$deeplink" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "deeplink$microflow" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$valuetype" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "deeplink$attribute" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$mxobjectreference" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "deeplink$entity" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$parameter" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
DELETE FROM "system$workflowusertaskoutcome_user"  WHERE "system$userid" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$mxobjectreference" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
DELETE FROM "system$userreportinfo_user"  WHERE "system$userid" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$microflows" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "email_connector$ldapconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "email_connector$oauthtoken" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "deeplink$attribute" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "deeplink$deeplink" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$mxobjecttype" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "system$queuedtask" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$mxobjectenumcaptions" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
UPDATE "mxmodelreflection$token" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
DELETE FROM "system$user"  WHERE "id" IN ( SELECT "id" FROM "f5fc30cfccd84318bc882cf5920f3863" );
DELETE FROM "2200ad66b4ce4d458d8435b84a10aa0d"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "f6d74e7e4a6e4f1da97dd0ceef2cac8a" );
DELETE FROM "99676624691e4d6ba428498aa9e7e9f0"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "f6d74e7e4a6e4f1da97dd0ceef2cac8a" );
DELETE FROM "fe20f68649d34fe2bc41e2b4af3d57d2"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "f6d74e7e4a6e4f1da97dd0ceef2cac8a" );
DELETE FROM "55ff5c010d4d46799c7262bdf70cd7b6"  WHERE "id" IN ( SELECT "id" FROM "f6d74e7e4a6e4f1da97dd0ceef2cac8a" );
DELETE FROM "system$thumbnail_image"  WHERE "system$imageid" IN ( SELECT "id" FROM "4689fa1484de4033bb66085f71aab966" );
DELETE FROM "system$image"  WHERE "id" IN ( SELECT "id" FROM "4689fa1484de4033bb66085f71aab966" );
DELETE FROM "system$filedocument"  WHERE "id" IN ( SELECT "id" FROM "4689fa1484de4033bb66085f71aab966" );
DELETE FROM "2200ad66b4ce4d458d8435b84a10aa0d"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "81f989d0e9dd41709fef1c6cb19965ee" );
DELETE FROM "99676624691e4d6ba428498aa9e7e9f0"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "81f989d0e9dd41709fef1c6cb19965ee" );
DELETE FROM "fe20f68649d34fe2bc41e2b4af3d57d2"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "81f989d0e9dd41709fef1c6cb19965ee" );
DELETE FROM "55ff5c010d4d46799c7262bdf70cd7b6"  WHERE "id" IN ( SELECT "id" FROM "81f989d0e9dd41709fef1c6cb19965ee" );
DROP TABLE "a25669c057084fefb2930d75966a7bc2";
DROP TABLE "fe20f68649d34fe2bc41e2b4af3d57d2";
DROP TABLE "99676624691e4d6ba428498aa9e7e9f0";
DROP TABLE "2200ad66b4ce4d458d8435b84a10aa0d";
DROP TABLE "669252c0fdeb4cae9e81b7ea43bff89a";
DROP TABLE "616195c65b7c4bf3a79402dba86033b9";
DROP TABLE "81f989d0e9dd41709fef1c6cb19965ee";
DROP TABLE "4689fa1484de4033bb66085f71aab966";
DROP TABLE "55ff5c010d4d46799c7262bdf70cd7b6";
DROP TABLE "f6d74e7e4a6e4f1da97dd0ceef2cac8a";
DROP TABLE "f5fc30cfccd84318bc882cf5920f3863";
UPDATE "mendixsystem$version" SET "versionnumber" = '4.2', "lastsyncdate" = '20240101 13:29:59';
