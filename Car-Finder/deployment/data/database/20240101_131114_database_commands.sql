...
ALTER TABLE "myfirstmodule$ad_user" RENAME TO "c365debd6ce942b89b0e0f9dfb4f1205";
...
ALTER TABLE "myfirstmodule$ad_vehicle" RENAME TO "9a4df0dcf47641279a0057041462e994";
...
ALTER TABLE "myfirstmodule$gallery_vehicle" RENAME TO "c335cce65d4e48ffb76a917db1c6bf70";
...
ALTER TABLE "myfirstmodule$vehicle_car" RENAME TO "1fb00089acb44512818fde8f25ac9cca";
ALTER TABLE "myfirstmodule$ad" RENAME TO "ad8ee8086e004c12ac12a82351fafc07";
DROP SEQUENCE "myfirstmodule$ad_adid_mxseq";
ALTER TABLE "myfirstmodule$car" RENAME TO "29d61792d2af40bb97552400f290d5bf";
ALTER TABLE "myfirstmodule$motorcycle" RENAME TO "8771c7b538614bddb327c99bdfa02637";
ALTER TABLE "myfirstmodule$gallery" RENAME TO "d8fddaa3f5c5481eb7b90db89f09269d";
DROP INDEX "idx_myfirstmodule$vehicle_submetaobjectname_asc";
ALTER TABLE "myfirstmodule$vehicle" RENAME TO "5b62434832914ae9b1d39d22db53427e";
ALTER TABLE "myfirstmodule$truck" RENAME TO "4ca632b4774f4dfabcd24c50b754d064";
ALTER TABLE "myfirstmodule$user" RENAME TO "f306df5c3e154cd0a7b3067fe933864c";
...
DELETE FROM "forgotpassword$forgotpassword_account"  WHERE "administration$accountid" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
DELETE FROM "administration$account"  WHERE "id" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
DELETE FROM "system$user_language"  WHERE "system$userid" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
DELETE FROM "system$userroles"  WHERE "system$userid" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
DELETE FROM "system$user_timezone"  WHERE "system$userid" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "email_connector$incomingemailconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "deeplink$pendinglink" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "email_connector$emailaccount" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "system$filedocument" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$valuetype" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "email_connector$emailaccount" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
DELETE FROM "system$tokeninformation_user"  WHERE "system$userid" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$mxobjectenumvalue" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "email_connector$emailtemplate" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "email_connector$emailtemplate" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "system$processedqueuetask" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
DELETE FROM "system$workflowusertask_targetusers"  WHERE "system$userid" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "system$workflow" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$mxobjectenumcaptions" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$microflows" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "email_connector$ldapconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "email_connector$emailmessage" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "deeplink$pendinglink" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "email_connector$oauthtoken" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "email_connector$outgoingemailconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$mxobjecttype" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
DELETE FROM "system$session_user"  WHERE "system$userid" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "email_connector$incomingemailconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
DELETE FROM "system$workflowactivity_actor"  WHERE "system$userid" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$mxobjectmember" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
DELETE FROM "system$workflowactivityusertaskoutcome_user"  WHERE "system$userid" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "email_connector$oauthprovider" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "deeplink$entity" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$parameter" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$token" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$mxobjectenumvalue" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
DELETE FROM "system$workflowusertask_assignees"  WHERE "system$userid" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "system$filedocument" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "email_connector$oauthprovider" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "email_connector$outgoingemailconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
DELETE FROM "forgotpassword$forgotpassword_anon_user_access"  WHERE "system$userid" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "deeplink$microflow" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$mxobjectmember" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "system$synchronizationerror" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "deeplink$deeplink" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "deeplink$microflow" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$valuetype" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "deeplink$attribute" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$mxobjectreference" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "deeplink$entity" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$parameter" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
DELETE FROM "system$workflowusertaskoutcome_user"  WHERE "system$userid" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$mxobjectreference" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
DELETE FROM "system$userreportinfo_user"  WHERE "system$userid" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$microflows" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "email_connector$ldapconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "email_connector$oauthtoken" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "deeplink$attribute" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "deeplink$deeplink" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$mxobjecttype" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "system$queuedtask" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$mxobjectenumcaptions" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
UPDATE "mxmodelreflection$token" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
DELETE FROM "system$user"  WHERE "id" IN ( SELECT "id" FROM "f306df5c3e154cd0a7b3067fe933864c" );
DELETE FROM "1fb00089acb44512818fde8f25ac9cca"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "4ca632b4774f4dfabcd24c50b754d064" );
DELETE FROM "c335cce65d4e48ffb76a917db1c6bf70"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "4ca632b4774f4dfabcd24c50b754d064" );
DELETE FROM "9a4df0dcf47641279a0057041462e994"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "4ca632b4774f4dfabcd24c50b754d064" );
DELETE FROM "5b62434832914ae9b1d39d22db53427e"  WHERE "id" IN ( SELECT "id" FROM "4ca632b4774f4dfabcd24c50b754d064" );
DELETE FROM "system$thumbnail_image"  WHERE "system$imageid" IN ( SELECT "id" FROM "d8fddaa3f5c5481eb7b90db89f09269d" );
DELETE FROM "system$image"  WHERE "id" IN ( SELECT "id" FROM "d8fddaa3f5c5481eb7b90db89f09269d" );
DELETE FROM "system$filedocument"  WHERE "id" IN ( SELECT "id" FROM "d8fddaa3f5c5481eb7b90db89f09269d" );
DELETE FROM "1fb00089acb44512818fde8f25ac9cca"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "8771c7b538614bddb327c99bdfa02637" );
DELETE FROM "c335cce65d4e48ffb76a917db1c6bf70"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "8771c7b538614bddb327c99bdfa02637" );
DELETE FROM "9a4df0dcf47641279a0057041462e994"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "8771c7b538614bddb327c99bdfa02637" );
DELETE FROM "5b62434832914ae9b1d39d22db53427e"  WHERE "id" IN ( SELECT "id" FROM "8771c7b538614bddb327c99bdfa02637" );
DROP TABLE "c365debd6ce942b89b0e0f9dfb4f1205";
DROP TABLE "9a4df0dcf47641279a0057041462e994";
DROP TABLE "c335cce65d4e48ffb76a917db1c6bf70";
DROP TABLE "1fb00089acb44512818fde8f25ac9cca";
DROP TABLE "ad8ee8086e004c12ac12a82351fafc07";
DROP TABLE "29d61792d2af40bb97552400f290d5bf";
DROP TABLE "8771c7b538614bddb327c99bdfa02637";
DROP TABLE "d8fddaa3f5c5481eb7b90db89f09269d";
DROP TABLE "5b62434832914ae9b1d39d22db53427e";
DROP TABLE "4ca632b4774f4dfabcd24c50b754d064";
DROP TABLE "f306df5c3e154cd0a7b3067fe933864c";
UPDATE "mendixsystem$version" SET "versionnumber" = '4.2', "lastsyncdate" = '20240101 13:11:14';
