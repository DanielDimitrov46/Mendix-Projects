...
ALTER TABLE "myfirstmodule$ad_user" RENAME TO "480f09dc86654c939cf46633f61f398a";
...
ALTER TABLE "myfirstmodule$ad_vehicle" RENAME TO "f67b13741dfc4aebb53a47f915cc2716";
...
ALTER TABLE "myfirstmodule$gallery_vehicle" RENAME TO "14ed1461d2934d1eb7705080bcfdec5b";
...
ALTER TABLE "myfirstmodule$vehicle_car" RENAME TO "bfa0e41a1e7f4112aee383864cba01e5";
ALTER TABLE "myfirstmodule$ad" RENAME TO "afb5184322374dd4bdbe3efb30f24f42";
DROP SEQUENCE "myfirstmodule$ad_adid_mxseq";
ALTER TABLE "myfirstmodule$car" RENAME TO "4f1539c094b64f179933015c852726b4";
ALTER TABLE "myfirstmodule$motorcycle" RENAME TO "6cba2f7942094ebeb2119df464dda39f";
ALTER TABLE "myfirstmodule$gallery" RENAME TO "be695f12925840bcb82370772e4d7b05";
DROP INDEX "idx_myfirstmodule$vehicle_submetaobjectname_asc";
ALTER TABLE "myfirstmodule$vehicle" RENAME TO "5d23728bb2d24cfb8d725dd27cba3a94";
ALTER TABLE "myfirstmodule$truck" RENAME TO "2fd86c54e89f46ba8658debe05abd8b2";
ALTER TABLE "myfirstmodule$user" RENAME TO "1bf14be705f440c49dbd54c530bc3ed2";
...
DELETE FROM "forgotpassword$forgotpassword_account"  WHERE "administration$accountid" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
DELETE FROM "administration$account"  WHERE "id" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
DELETE FROM "system$user_language"  WHERE "system$userid" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
DELETE FROM "system$userroles"  WHERE "system$userid" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
DELETE FROM "system$user_timezone"  WHERE "system$userid" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "email_connector$incomingemailconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "deeplink$pendinglink" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "email_connector$emailaccount" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "system$filedocument" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$valuetype" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "email_connector$emailaccount" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
DELETE FROM "system$tokeninformation_user"  WHERE "system$userid" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$mxobjectenumvalue" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "email_connector$emailtemplate" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "email_connector$emailtemplate" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "system$processedqueuetask" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
DELETE FROM "system$workflowusertask_targetusers"  WHERE "system$userid" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "system$workflow" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$mxobjectenumcaptions" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$microflows" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "email_connector$ldapconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "email_connector$emailmessage" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "deeplink$pendinglink" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "email_connector$oauthtoken" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "email_connector$outgoingemailconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$mxobjecttype" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
DELETE FROM "system$session_user"  WHERE "system$userid" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "email_connector$incomingemailconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
DELETE FROM "system$workflowactivity_actor"  WHERE "system$userid" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$mxobjectmember" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
DELETE FROM "system$workflowactivityusertaskoutcome_user"  WHERE "system$userid" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "email_connector$oauthprovider" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "deeplink$entity" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$parameter" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$token" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$mxobjectenumvalue" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
DELETE FROM "system$workflowusertask_assignees"  WHERE "system$userid" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "system$filedocument" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "email_connector$oauthprovider" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "email_connector$outgoingemailconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
DELETE FROM "forgotpassword$forgotpassword_anon_user_access"  WHERE "system$userid" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "deeplink$microflow" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$mxobjectmember" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "system$synchronizationerror" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "deeplink$deeplink" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "deeplink$microflow" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$valuetype" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "deeplink$attribute" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$mxobjectreference" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "deeplink$entity" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$parameter" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
DELETE FROM "system$workflowusertaskoutcome_user"  WHERE "system$userid" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$mxobjectreference" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
DELETE FROM "system$userreportinfo_user"  WHERE "system$userid" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$microflows" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "email_connector$ldapconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "email_connector$oauthtoken" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "deeplink$attribute" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "deeplink$deeplink" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$mxobjecttype" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "system$queuedtask" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$mxobjectenumcaptions" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
UPDATE "mxmodelreflection$token" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
DELETE FROM "system$user"  WHERE "id" IN ( SELECT "id" FROM "1bf14be705f440c49dbd54c530bc3ed2" );
DELETE FROM "bfa0e41a1e7f4112aee383864cba01e5"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "2fd86c54e89f46ba8658debe05abd8b2" );
DELETE FROM "14ed1461d2934d1eb7705080bcfdec5b"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "2fd86c54e89f46ba8658debe05abd8b2" );
DELETE FROM "f67b13741dfc4aebb53a47f915cc2716"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "2fd86c54e89f46ba8658debe05abd8b2" );
DELETE FROM "5d23728bb2d24cfb8d725dd27cba3a94"  WHERE "id" IN ( SELECT "id" FROM "2fd86c54e89f46ba8658debe05abd8b2" );
DELETE FROM "system$thumbnail_image"  WHERE "system$imageid" IN ( SELECT "id" FROM "be695f12925840bcb82370772e4d7b05" );
DELETE FROM "system$image"  WHERE "id" IN ( SELECT "id" FROM "be695f12925840bcb82370772e4d7b05" );
DELETE FROM "system$filedocument"  WHERE "id" IN ( SELECT "id" FROM "be695f12925840bcb82370772e4d7b05" );
DELETE FROM "bfa0e41a1e7f4112aee383864cba01e5"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "6cba2f7942094ebeb2119df464dda39f" );
DELETE FROM "14ed1461d2934d1eb7705080bcfdec5b"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "6cba2f7942094ebeb2119df464dda39f" );
DELETE FROM "f67b13741dfc4aebb53a47f915cc2716"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "6cba2f7942094ebeb2119df464dda39f" );
DELETE FROM "5d23728bb2d24cfb8d725dd27cba3a94"  WHERE "id" IN ( SELECT "id" FROM "6cba2f7942094ebeb2119df464dda39f" );
DROP TABLE "480f09dc86654c939cf46633f61f398a";
DROP TABLE "f67b13741dfc4aebb53a47f915cc2716";
DROP TABLE "14ed1461d2934d1eb7705080bcfdec5b";
DROP TABLE "bfa0e41a1e7f4112aee383864cba01e5";
DROP TABLE "afb5184322374dd4bdbe3efb30f24f42";
DROP TABLE "4f1539c094b64f179933015c852726b4";
DROP TABLE "6cba2f7942094ebeb2119df464dda39f";
DROP TABLE "be695f12925840bcb82370772e4d7b05";
DROP TABLE "5d23728bb2d24cfb8d725dd27cba3a94";
DROP TABLE "2fd86c54e89f46ba8658debe05abd8b2";
DROP TABLE "1bf14be705f440c49dbd54c530bc3ed2";
UPDATE "mendixsystem$version" SET "versionnumber" = '4.2', "lastsyncdate" = '20240101 13:36:24';
