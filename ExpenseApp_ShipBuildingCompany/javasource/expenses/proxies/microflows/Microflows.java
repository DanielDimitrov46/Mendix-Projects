...
public final class Microflows
{
	...
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder aCO_RequestLine_CalculateTotalAmountBuilder(
		expenses.proxies.RequestLine _requestLine
	)
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("Expenses.ACO_RequestLine_CalculateTotalAmount");
		builder = builder.withParam("RequestLine", _requestLine);
		return builder;
	}

	public static void aCO_RequestLine_CalculateTotalAmount(
		IContext context,
		expenses.proxies.RequestLine _requestLine
	)
	{
		aCO_RequestLine_CalculateTotalAmountBuilder(
				_requestLine
			)
			.execute(context);
	}
	...
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder aCT_Request_Step1Builder(
		expenses.proxies.Request _request
	)
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("Expenses.ACT_Request_Step1");
		builder = builder.withParam("Request", _request);
		return builder;
	}

	public static void aCT_Request_Step1(
		IContext context,
		expenses.proxies.Request _request
	)
	{
		aCT_Request_Step1Builder(
				_request
			)
			.execute(context);
	}
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder aCT_Request_Step2Builder(
		expenses.proxies.Request _request
	)
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("Expenses.ACT_Request_Step2");
		builder = builder.withParam("Request", _request);
		return builder;
	}

	public static void aCT_Request_Step2(
		IContext context,
		expenses.proxies.Request _request
	)
	{
		aCT_Request_Step2Builder(
				_request
			)
			.execute(context);
	}
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder aCT_Request_Step3Builder(
		expenses.proxies.Request _request
	)
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("Expenses.ACT_Request_Step3");
		builder = builder.withParam("Request", _request);
		return builder;
	}

	public static void aCT_Request_Step3(
		IContext context,
		expenses.proxies.Request _request
	)
	{
		aCT_Request_Step3Builder(
				_request
			)
			.execute(context);
	}
	...
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder dS_Request_GetForUserRoleBuilder()
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("Expenses.DS_Request_GetForUserRole");
		return builder;
	}

	public static java.util.List<expenses.proxies.Request> dS_Request_GetForUserRole(IContext context)
	{
		Object result = dS_Request_GetForUserRoleBuilder().execute(context);
	...
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder headerData_GetOrCreateBuilder()
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("Expenses.HeaderData_GetOrCreate");
		return builder;
	}

	public static expenses.proxies.HeaderData headerData_GetOrCreate(IContext context)
	{
		Object result = headerData_GetOrCreateBuilder().execute(context);
		return result == null ? null : expenses.proxies.HeaderData.initialize(context, (IMendixObject) result);
	}
