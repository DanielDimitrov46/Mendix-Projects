...
public class Team
{
	...
	{
		Name("Name"),
		Captain_Team("SoccerSquad.Captain_Team"),
		Stadium_Team("SoccerSquad.Stadium_Team");
	 ...
	 */
	public final soccersquad.proxies.Player getCaptain_Team() throws com.mendix.core.CoreException
	{
	 ...
	 * @throws com.mendix.core.CoreException
	 */
	public final soccersquad.proxies.Player getCaptain_Team(com.mendix.systemwideinterfaces.core.IContext context) throws com.mendix.core.CoreException
	{
	 ...
	 * @param captain_team
	 */
	public final void setCaptain_Team(soccersquad.proxies.Player captain_team)
	{
	 ...
	 * @param captain_team
	 */
	public final void setCaptain_Team(com.mendix.systemwideinterfaces.core.IContext context, soccersquad.proxies.Player captain_team)
	{
	...
	/**
	 * @throws com.mendix.core.CoreException
	 * @return value of Stadium_Team
	 */
	public final soccersquad.proxies.Stadium getStadium_Team() throws com.mendix.core.CoreException
	{
		return getStadium_Team(getContext());
	}
	 ...
	 * @throws com.mendix.core.CoreException
	 */
	public final soccersquad.proxies.Stadium getStadium_Team(com.mendix.systemwideinterfaces.core.IContext context) throws com.mendix.core.CoreException
	{
		soccersquad.proxies.Stadium result = null;
		com.mendix.systemwideinterfaces.core.IMendixIdentifier identifier = getMendixObject().getValue(context, MemberNames.Stadium_Team.toString());
		if (identifier != null) {
	...
	/**
	 * Set value of Stadium_Team
	 * @param stadium_team
	 */
	public final void setStadium_Team(soccersquad.proxies.Stadium stadium_team)
	{
		setStadium_Team(getContext(), stadium_team);
	}
	 ...
	 * @param stadium_team
	 */
	public final void setStadium_Team(com.mendix.systemwideinterfaces.core.IContext context, soccersquad.proxies.Stadium stadium_team)
	{
		if (stadium_team == null) {
			getMendixObject().setValue(context, MemberNames.Stadium_Team.toString(), null);
		} else {
			getMendixObject().setValue(context, MemberNames.Stadium_Team.toString(), stadium_team.getMendixObject().getId());
		}
	}
