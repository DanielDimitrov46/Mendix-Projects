...
export default {
    ...
    plugins: [
        mendixResolve(
            ...
            "D:/UKTC PROGRAMMING/Mendix-Projects/Going mobile course/deployment/web/cachetag.txt"
        ),
        nodePolyfills(),
        esbuild({
        ...
        generatePrecacheServiceWorker({
            deploymentDir: "D:/UKTC PROGRAMMING/Mendix-Projects/Going mobile course/deployment"
        }),
        copy({
            targets: [
              { src: 'D:/UKTC PROGRAMMING/Mendix-Projects/Going mobile course/deployment/web/widgets/*', dest: 'dist' },
            ]
        })
    ],
};
