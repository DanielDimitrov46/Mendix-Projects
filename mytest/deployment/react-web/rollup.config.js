...
export default {
    ...
    plugins: [
        mendixResolve(
            ...
            "D:/UKTC PROGRAMMING/Mendix-Projects/mytest/deployment/web/cachetag.txt"
        ),
        nodePolyfills(),
        esbuild({
        ...
        generatePrecacheServiceWorker({
            deploymentDir: "D:/UKTC PROGRAMMING/Mendix-Projects/mytest/deployment"
        }),
        copy({
            targets: [
              { src: 'D:/UKTC PROGRAMMING/Mendix-Projects/mytest/deployment/web/widgets/*', dest: 'dist' },
            ]
        })
    ],
};
