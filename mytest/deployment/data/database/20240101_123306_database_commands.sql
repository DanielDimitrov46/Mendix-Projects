...
ALTER TABLE "myfirstmodule$ad_user" RENAME TO "3cdd202f80f84fbfb5a47fae42f7efa3";
...
ALTER TABLE "myfirstmodule$ad_vehicle" RENAME TO "4f1e7c6e682443de8011dc190731ca8e";
...
ALTER TABLE "myfirstmodule$gallery_vehicle" RENAME TO "1c997344d754491ab84a568d4e048b1c";
...
ALTER TABLE "myfirstmodule$vehicle_car" RENAME TO "e277494deff84e0ab44a21e10c2ca364";
ALTER TABLE "myfirstmodule$ad" RENAME TO "dbc9f456a2e544a1ba20eb74f78fd94c";
DROP SEQUENCE "myfirstmodule$ad_adid_mxseq";
ALTER TABLE "myfirstmodule$car" RENAME TO "2562a3a53f8f466897c82acff72f99a0";
ALTER TABLE "myfirstmodule$motorcycle" RENAME TO "480c6dd7cd7342bcb7069699409f8ba7";
ALTER TABLE "myfirstmodule$gallery" RENAME TO "aa8d4141586043dd8ff282c9485468aa";
DROP INDEX "idx_myfirstmodule$vehicle_submetaobjectname_asc";
ALTER TABLE "myfirstmodule$vehicle" RENAME TO "7ed09f8a74a0427982b2bf94c740b909";
ALTER TABLE "myfirstmodule$truck" RENAME TO "ebbcae75df5a4d5ea376af45431bd1fb";
ALTER TABLE "myfirstmodule$user" RENAME TO "7243eb85789248da855240176480e155";
...
DELETE FROM "forgotpassword$forgotpassword_account"  WHERE "administration$accountid" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
DELETE FROM "administration$account"  WHERE "id" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
DELETE FROM "system$user_language"  WHERE "system$userid" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
DELETE FROM "system$userroles"  WHERE "system$userid" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
DELETE FROM "system$user_timezone"  WHERE "system$userid" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "email_connector$incomingemailconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "deeplink$pendinglink" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "email_connector$emailaccount" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "system$filedocument" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$valuetype" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "email_connector$emailaccount" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
DELETE FROM "system$tokeninformation_user"  WHERE "system$userid" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$mxobjectenumvalue" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "email_connector$emailtemplate" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "email_connector$emailtemplate" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "system$processedqueuetask" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
DELETE FROM "system$workflowusertask_targetusers"  WHERE "system$userid" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "system$workflow" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$mxobjectenumcaptions" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$microflows" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "email_connector$ldapconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "email_connector$emailmessage" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "deeplink$pendinglink" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "email_connector$oauthtoken" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "email_connector$outgoingemailconfiguration" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$mxobjecttype" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
DELETE FROM "system$session_user"  WHERE "system$userid" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "email_connector$incomingemailconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
DELETE FROM "system$workflowactivity_actor"  WHERE "system$userid" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$mxobjectmember" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
DELETE FROM "system$workflowactivityusertaskoutcome_user"  WHERE "system$userid" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "email_connector$oauthprovider" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "deeplink$entity" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$parameter" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$token" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$mxobjectenumvalue" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
DELETE FROM "system$workflowusertask_assignees"  WHERE "system$userid" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "system$filedocument" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "email_connector$oauthprovider" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "email_connector$outgoingemailconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
DELETE FROM "forgotpassword$forgotpassword_anon_user_access"  WHERE "system$userid" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "deeplink$microflow" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$mxobjectmember" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "system$synchronizationerror" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "deeplink$deeplink" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "deeplink$microflow" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$valuetype" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "deeplink$attribute" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$mxobjectreference" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "deeplink$entity" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$parameter" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
DELETE FROM "system$workflowusertaskoutcome_user"  WHERE "system$userid" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$mxobjectreference" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
DELETE FROM "system$userreportinfo_user"  WHERE "system$userid" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$microflows" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "email_connector$ldapconfiguration" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "email_connector$oauthtoken" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "deeplink$attribute" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "deeplink$deeplink" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$mxobjecttype" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "system$queuedtask" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$mxobjectenumcaptions" SET "system$owner" = NULL WHERE "system$owner" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
UPDATE "mxmodelreflection$token" SET "system$changedby" = NULL WHERE "system$changedby" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
DELETE FROM "system$user"  WHERE "id" IN ( SELECT "id" FROM "7243eb85789248da855240176480e155" );
DELETE FROM "e277494deff84e0ab44a21e10c2ca364"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "ebbcae75df5a4d5ea376af45431bd1fb" );
DELETE FROM "1c997344d754491ab84a568d4e048b1c"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "ebbcae75df5a4d5ea376af45431bd1fb" );
DELETE FROM "4f1e7c6e682443de8011dc190731ca8e"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "ebbcae75df5a4d5ea376af45431bd1fb" );
DELETE FROM "7ed09f8a74a0427982b2bf94c740b909"  WHERE "id" IN ( SELECT "id" FROM "ebbcae75df5a4d5ea376af45431bd1fb" );
DELETE FROM "system$thumbnail_image"  WHERE "system$imageid" IN ( SELECT "id" FROM "aa8d4141586043dd8ff282c9485468aa" );
DELETE FROM "system$image"  WHERE "id" IN ( SELECT "id" FROM "aa8d4141586043dd8ff282c9485468aa" );
DELETE FROM "system$filedocument"  WHERE "id" IN ( SELECT "id" FROM "aa8d4141586043dd8ff282c9485468aa" );
DELETE FROM "e277494deff84e0ab44a21e10c2ca364"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "480c6dd7cd7342bcb7069699409f8ba7" );
DELETE FROM "1c997344d754491ab84a568d4e048b1c"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "480c6dd7cd7342bcb7069699409f8ba7" );
DELETE FROM "4f1e7c6e682443de8011dc190731ca8e"  WHERE "myfirstmodule$vehicleid" IN ( SELECT "id" FROM "480c6dd7cd7342bcb7069699409f8ba7" );
DELETE FROM "7ed09f8a74a0427982b2bf94c740b909"  WHERE "id" IN ( SELECT "id" FROM "480c6dd7cd7342bcb7069699409f8ba7" );
DROP TABLE "3cdd202f80f84fbfb5a47fae42f7efa3";
DROP TABLE "4f1e7c6e682443de8011dc190731ca8e";
DROP TABLE "1c997344d754491ab84a568d4e048b1c";
DROP TABLE "e277494deff84e0ab44a21e10c2ca364";
DROP TABLE "dbc9f456a2e544a1ba20eb74f78fd94c";
DROP TABLE "2562a3a53f8f466897c82acff72f99a0";
DROP TABLE "480c6dd7cd7342bcb7069699409f8ba7";
DROP TABLE "aa8d4141586043dd8ff282c9485468aa";
DROP TABLE "7ed09f8a74a0427982b2bf94c740b909";
DROP TABLE "ebbcae75df5a4d5ea376af45431bd1fb";
DROP TABLE "7243eb85789248da855240176480e155";
UPDATE "mendixsystem$version" SET "versionnumber" = '4.2', "lastsyncdate" = '20240101 12:33:06';
