...
public class Booking implements com.mendix.systemwideinterfaces.core.IEntityProxy
{
	 ...
	 */
	public static final java.lang.String entityName = "Rooms.Booking";
	...
	public enum MemberNames
	{
		...
		Booking_Room("Rooms.Booking_Room");
	 ...
	 */
	public static rooms.proxies.Booking initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new rooms.proxies.Booking(context, mendixObject);
	}

	public static rooms.proxies.Booking load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return rooms.proxies.Booking.initialize(context, mendixObject);
	}

	public static java.util.List<rooms.proxies.Booking> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		return com.mendix.core.Core.createXPathQuery(String.format("//%1$s%2$s", entityName, xpathConstraint))
			.execute(context)
			.stream()
			.map(obj -> rooms.proxies.Booking.initialize(context, obj))
	...
	public boolean equals(Object obj)
	{
		...
		{
			final rooms.proxies.Booking that = (rooms.proxies.Booking) obj;
