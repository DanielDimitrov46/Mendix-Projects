...
export default {
    ...
    plugins: [
        ...
        generatePrecacheServiceWorker({
            deploymentDir: "D:/UKTC PROGRAMMING/Mendix-Projects/Booking System-Bookster/deployment"
        }),
        copy({
            targets: [
              { src: 'D:/UKTC PROGRAMMING/Mendix-Projects/Booking System-Bookster/deployment/web/widgets/*', dest: 'dist' },
            ]
        })
    ],
};
