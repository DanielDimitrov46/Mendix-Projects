...
public final class Microflows
{
	...
	public static com.mendix.core.actionmanagement.MicroflowCallBuilder bCO_TicketItemBuilder(
		eventmanagement.proxies.Ticket _ticket
	)
	{
		com.mendix.core.actionmanagement.MicroflowCallBuilder builder = Core.microflowCall("EventManagement.BCO_TicketItem");
		builder = builder.withParam("Ticket", _ticket);
		return builder;
	}

	public static boolean bCO_TicketItem(
		IContext context,
		eventmanagement.proxies.Ticket _ticket
	)
	{
		Object result = bCO_TicketItemBuilder(
				_ticket
			)
			.execute(context);
		return (boolean) result;
