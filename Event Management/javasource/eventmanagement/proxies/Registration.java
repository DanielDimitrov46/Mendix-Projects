...
public class Registration implements com.mendix.systemwideinterfaces.core.IEntityProxy
{
	 ...
	 */
	public final eventmanagement.proxies.Ticket getRegistration_Ticket() throws com.mendix.core.CoreException
	{
	 ...
	 * @throws com.mendix.core.CoreException
	 */
	public final eventmanagement.proxies.Ticket getRegistration_Ticket(com.mendix.systemwideinterfaces.core.IContext context) throws com.mendix.core.CoreException
	{
		eventmanagement.proxies.Ticket result = null;
		com.mendix.systemwideinterfaces.core.IMendixIdentifier identifier = getMendixObject().getValue(context, MemberNames.Registration_Ticket.toString());
		if (identifier != null) {
			result = eventmanagement.proxies.Ticket.load(context, identifier);
		}
		return result;
	}
	 ...
	 */
	public final void setRegistration_Ticket(eventmanagement.proxies.Ticket registration_ticket)
	{
	 ...
	 * @param registration_ticket
	 */
	public final void setRegistration_Ticket(com.mendix.systemwideinterfaces.core.IContext context, eventmanagement.proxies.Ticket registration_ticket)
	{
		if (registration_ticket == null) {
			getMendixObject().setValue(context, MemberNames.Registration_Ticket.toString(), null);
		} else {
			getMendixObject().setValue(context, MemberNames.Registration_Ticket.toString(), registration_ticket.getMendixObject().getId());
		}
	}
