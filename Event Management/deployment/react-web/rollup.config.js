...
export default {
    ...
    plugins: [
        mendixResolve(
            ...
            "D:/UKTC PROGRAMMING/Mendix-Projetcs/Event Management/deployment/web/cachetag.txt"
        ),
        nodePolyfills(),
        esbuild({
        ...
        generatePrecacheServiceWorker({
            deploymentDir: "D:/UKTC PROGRAMMING/Mendix-Projetcs/Event Management/deployment"
        }),
        copy({
            targets: [
              { src: 'D:/UKTC PROGRAMMING/Mendix-Projetcs/Event Management/deployment/web/widgets/*', dest: 'dist' },
            ]
        })
    ],
};
