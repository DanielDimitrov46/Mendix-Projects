...
import { mainContent, sidebar } from "D:/UKTC PROGRAMMING/Mendix-Projetcs/MQTT-SmartHome/deployment/native/layouts/Atlas_Core.NativePhone_TopBarOnly.js";
        ...
        content={[
            <$DataView key="p0.NativeMobile.Login.dataView2"
                ...
                object={NanoflowObjectProperty({
                    "dataSourceId": "p0.4",
                    "editable": true,
                    "source": { "nanoflow": () => require("D:/UKTC PROGRAMMING/Mendix-Projetcs/MQTT-SmartHome/deployment/native/nanoflows/NativeMobile.DSS_CreateLoginContext").DSS_CreateLoginContext },
                    "argMap": {}
                })}
                content={[
                    ...
                    <$Button key="p0.NativeMobile.Login.actionButton2"
                        ...
                        onClick={ActionProperty({
                            "action": { "type": "callNanoflow", "argMap": { "Login": { "widget": "p0.NativeMobile.Login.dataView2", "source": "object" } }, "config": { "nanoflow": () => require("D:/UKTC PROGRAMMING/Mendix-Projetcs/MQTT-SmartHome/deployment/native/nanoflows/NativeMobile.ACT_SignInUser").ACT_SignInUser }, "disabledDuringExecution": false }
                        })}
                        accessible={false} />,
