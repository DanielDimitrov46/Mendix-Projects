...
export default {
    ...
    plugins: [
        mendixResolve(
            ...
            "D:/UKTC PROGRAMMING/FootballClub/deployment/web/cachetag.txt"
        ),
        nodePolyfills(),
        esbuild({
        ...
        generatePrecacheServiceWorker({
            deploymentDir: "D:/UKTC PROGRAMMING/FootballClub/deployment"
        }),
        copy({
            targets: [
              { src: 'D:/UKTC PROGRAMMING/FootballClub/deployment/web/widgets/*', dest: 'dist' },
            ]
        })
    ],
};
